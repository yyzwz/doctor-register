            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="doctorName">
                        <Input type="text" v-model="searchForm.doctorName" placeholder="请输入医生名称" clearable style="width: 200px" />
                    </Form-item>
                    <Form-item label="" prop="date">
                        <Input type="text" v-model="searchForm.date" placeholder="请输入号源日期" clearable style="width: 200px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getDoctorNumberList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
