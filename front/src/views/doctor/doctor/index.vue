...
<div class="search">
            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="name">
                        <Input type="text" v-model="searchForm.name" placeholder="请输入医生姓名" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="level">
                        <Select v-model="searchForm.level" placeholder="医生职称" clearable style="width: 150px">
                    ...
                    <Form-item label="" prop="departmentId">
                        <Select v-model="searchForm.departmentId" placeholder="科室" clearable style="width: 150px">
    ...
    <Modal v-model="orderModal" draggable :title="orderTitle" :mask="false" footer-hide width="1200">
        <Form :label-width="100" label-position="left">
            <Row :gutter="16">
                <Col span="24">
                <FormItem label="医生姓名">
                    <Input v-model="addOrderName" clearable style="width:100%" />
                </FormItem>
                </Col>
                <Col span="24">
                <FormItem label="放号日期">
                    <DatePicker type="date" placeholder="放号日期" format="yyyy-MM-dd" @on-change="changeAddOrderDate" style="width: 100%"></DatePicker>
                </FormItem>
                </Col>
                <Col span="24">
                <FormItem label="放号数量">
                    <InputNumber v-model="addOrderNumber" min="1" max="100" style="width:100%"></InputNumber>
                </FormItem>
                </Col>
                <Col span="24">
                <Divider>
                    <Button @click="fangOrderFx" :loading="orderLoading" type="primary">确认放号</Button>
                </Divider>
                </Col>
            </Row>
        </Form>
...
export default {
                                ...
                                "Button", {
                                    ...
                                    on: {
                                        click: () => {
                                            ...
                                            this.orderTitle = params.row.name + "[" + params.row.level + "] 放号";
                                            this.addOrderName = params.row.name;
                                            this.addOrderDate = "";
                                            this.addOrderNumber = 1;
                                            this.orderModal = true;
                                            // this.fangOrderFx(params.row);
                                        }
                                    }
                                },
                                "放号"
    ...
    methods: {
        ...
        fangOrderFx() {
            ...
            fangOrder({
                doctorId: that.selectMyRow.id,
                date: that.addOrderDate,
                number: that.addOrderNumber
            }).then(res => {
